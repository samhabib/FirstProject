'''This week’s exercise is going to be revisiting an old exercise (see Exercise 5), except require the solution in a
different way.
...
MergedList = [c for c in a for d in b if c == d ]
